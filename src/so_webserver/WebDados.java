...
public class WebDados implements Runnable{
    ...
    static  String nome, dia, tempo, maxima, minima, sigla, ext = ".png", imagem = "http://img0.cptec.inpe.br/~rgrafico/icones_principais/tempo/icones/";;
    ...
    public void run() {
        while(true){
            synchronized(this){
              try {
                    ...
                    URL url = new URL("http://servicos.cptec.inpe.br/XML/cidade/4599/previsao.xml");
                    ...
                    for (int temp = 0; temp < nList.getLength(); temp++) {
                        ...
                        if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                            ...
                            if(tempo.intern() == "pcm"){
                              tempo = "Possibilidade de Chuva pela Manha";
                            }
                            if(tempo.intern() == "pct"){
                            ...
                            if(tempo.intern() == "vn"){
                              tempo = "Variacao de Nebulosidade";
                            }
                            if(tempo.intern() == "ct"){
                              tempo = "Chuva a Tarde";
                            }
       ...
       +           "<h1> Nome: "+nome+" </h1>"
       +           "<h1> dia: "+dia+" </h1>"
       +           "<h1> tempo: "+tempo+ "</h1><img src="+imagem+sigla+ext+">"
       +           "<h1> maximo: "+maxima+" </h1>"
       +           "<h1> minima: "+minima+" </h1>"
       +       "</body>"
       +   "</html>"
